...
var TranslationRoutes_1 = __importDefault(require("./routes/TranslationRoutes"));
// Configure Server
var server = new ServerConfig_1.default();
server.app.listen(server.port, function () {
    console.log("Vocabularium server (v1.0) is listening on port ".concat(server.port, "."));
});
// Configure Routes
var packRoutes = new PackRoutes_1.default(server.app);
var cardRoutes = new CardRoutes_1.default(server.app);
var translationRoutes = new TranslationRoutes_1.default(server.app);
