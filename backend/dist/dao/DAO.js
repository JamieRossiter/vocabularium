...
var DAO = /** @class */ (function () {
    ...
    DAO.prototype.connectToDb = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this._client.connect()];
                    case 2:
                        _a.sent();
                        connected = true;
                        return [3 /*break*/, 4];
    ...
    DAO.prototype.accessCollection = function (collectionName) {
        return __awaiter(this, void 0, void 0, function () {
            var db, collection;
            return __generator(this, function (_a) {
                db = this._client.db(this._dbName);
